...
echo "<html><head><title>|| Assign to 1B ||</title>
...
$dat=date('Y-m-d');
$sql1="SELECT Cid,Subid,Dates FROM Homework WHERE Cid='1B' AND Subid='$subid' AND Dates='$dat'";
...
$sql1="INSERT INTO Homework(Cid,Subid,Homeworks,Dates) VALUES ('1B','$subid','$hw','$dat')";
if(mysqli_query($con,$sql1)){
	
		$dat=date('Y-m-d');

echo "<form method='post' action='tview.php'>
<p><input type='date' value='$dat' name='dat' class='textbox'> <input type='hidden' name='classrad' value='1B'> 
