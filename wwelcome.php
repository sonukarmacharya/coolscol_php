...
echo "<html>
   ...
   echo"
     <h1>Welcome To CoolSchool Diary!!</h1><br/><br/>
	  ...
	  Email:<table border='0' cellspacing='0' class='tabtext'><tr><td> &nbsp;<input type='textbox' name='email' class='textbox' required></td></tr></table><br>
	  Password:<table class='tabtext' border='0' cellspacing='0'><tr><td> &nbsp;<input type='password' name='pw' class='textbox' required></td></tr></table><br>
